...
def get_url_header(env_select):
    urls = {
        ...
        "私有化环境": "http://192.168.1.100:30031",
...
def get_token(env_select):
    urls = {
        ...
        "私有化环境": "http://192.168.1.100:30031/api/auth/login?authType=USER&auth_type=USER&username=YOUR_ACCOUNT&password=YOUR_PASSWORD&clientId=DEVICE_MANAGEMENT",
